...
class __TwigTemplate_540502573cb197f7a596bbad9d7f99e5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<h1>Activer votre compte </h1>
<p>Bonjour ";
        // line 2
        ...
        echo ",</p>
<p>Votre inscription sur notre site est a valider en cliquant sur le lien ci-dessous :</p>
<p><a href=\"";
        // line 4
...
";
        // line 5
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("verify_user", ["token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 5, $this->source); })())])), "html", null, true);
        echo "
</a></p>
<p>Ce lien expirera dans 3 heures</p>";
    ...
    {
        return new Source("<h1>Activer votre compte </h1>
<p>Bonjour {{ user.username }},</p>
<p>Votre inscription sur notre site est a valider en cliquant sur le lien ci-dessous :</p>
<p><a href=\"{{ absolute_url(path('verify_user',{token: token})) }}\">
{{ absolute_url(path('verify_user',{token: token})) }}
</a></p>
<p>Ce lien expirera dans 3 heures</p>", "emails/register.html.twig", "C:\\xampp\\htdocs\\PIDEV\\templates\\emails\\register.html.twig");
    }
}
