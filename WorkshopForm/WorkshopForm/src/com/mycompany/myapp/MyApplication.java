...
public class MyApplication {
    ...
    /********************************PARTIE CODE*******************************************/ 
        ...
        Form f2=(Form)new Form("Resultat",new BoxLayout(BoxLayout.Y_AXIS));
        Form f=(Form) new Form("Inscription",new BoxLayout(BoxLayout.Y_AXIS));
       
        TextField nom=new TextField("", "nom");
        c.add(nom);
        TextField prenom=new TextField("", "prenom");
        c.add(prenom);
        TextField password=new TextField("", "", 0, TextField.PASSWORD);
        c.add(password);
        ...
        c.add(natation);
        Button inscription= new Button("Valider");
        c.add(inscription);
        Command cmd=new Command("Test");
        f.add(c);
